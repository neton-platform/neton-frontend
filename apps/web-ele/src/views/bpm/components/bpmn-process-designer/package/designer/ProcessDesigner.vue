  ...
  <div class="my-process-designer">
      ...
      <template v-if="!$slots['control-header']">
        <ElButtonGroup key="file-control">
          ...
          <ElTooltip placement="bottom">
            <template #content>
              <div>
                <ElButton type="primary" link @click="downloadProcessAsXml()">
                  下载为XML文件
                </ElButton>
                <br />
                <ElButton type="primary" link @click="downloadProcessAsSvg()">
                  下载为SVG文件
                </ElButton>
                <br />
                <ElButton type="primary" link @click="downloadProcessAsBpmn()">
                  下载为BPMN文件
                </ElButton>
              </div>
            </template>
            <ElButton :icon="DownloadOutlined" title="下载文件" />
          </ElTooltip>
          <ElTooltip>
            <template #content>
              <ElButton type="primary" link @click="previewProcessXML">
                预览XML
              </ElButton>
              <br />
              <ElButton type="primary" link @click="previewProcessJson">
                预览JSON
              </ElButton>
            </template>
            <ElButton :icon="EyeOutlined" title="浏览" />
          </ElTooltip>
          <ElTooltip
        ...
        <ElButtonGroup key="scale-control">
          ...
          <ElButton>{{ `${Math.floor(defaultZoom * 10 * 10)}%` }}</ElButton>
          <ElTooltip content="放大视图">
            <ElButton
              :icon="ZoomInOutlined"
              @click="processZoomIn()"
          ...
          <ElTooltip content="重置视图并居中">
            <ElButton :icon="ReloadOutlined" @click="processReZoom()" />
          </ElTooltip>
        </ElButtonGroup>
        <ElButtonGroup key="stack-control">
          ...
          <ElTooltip content="重新绘制">
            <ElButton :icon="ReloadOutlined" @click="processRestart()" />
          </ElTooltip>
        </ElButtonGroup>
      </template>
      <!-- 用于打开本地文件-->
    ...
    >
      <div>
        ...
        <pre><code v-html="highlightedCode(previewResult)" class="hljs"></code></pre>
      </div>
    </ElDialog>
  </div>
</template>
