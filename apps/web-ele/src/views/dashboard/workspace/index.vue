...
const projectItems: WorkbenchProjectItem[] = [
  ...
  {
    color: '#409EFF',
    content: 'github.com/netoncode/neton-ui-admin-vue3',
    date: '2025-02-03',
    group: 'Vue3 + element-plus 管理后台',
    icon: 'ep:element-plus',
    title: 'neton-ui-admin-vue3',
    url: 'https://github.com/netoncode/neton-ui-admin-vue3',
  },
  {
    color: '#ff4d4f',
    content: 'github.com/netoncode/neton-mall-uniapp',
    date: '2025-03-04',
    group: 'Vue3 + uniapp 商城手机端',
    icon: 'icon-park-outline:mall-bag',
    title: 'neton-mall-uniapp',
    url: 'https://github.com/netoncode/neton-mall-uniapp',
  },
  {
    color: '#1890ff',
    content: 'github.com/YunaiV/neton-cloud',
    date: '2025-04-05',
    group: 'Spring Cloud 微服务架构',
    icon: 'material-symbols:cloud-outline',
    title: 'neton-cloud',
    url: 'https://github.com/YunaiV/neton-cloud',
  },
  {
    color: '#e18525',
  ...
  {
    color: '#2979ff',
    content: 'github.com/netoncode/neton-ui-admin-uniapp',
    date: '2025-06-01',
    group: 'Vue3 + uniapp 管理手机端',
    icon: 'ant-design:mobile',
    title: 'neton-ui-admin-uniapp',
    url: 'https://github.com/netoncode/neton-ui-admin-uniapp',
  },
];
